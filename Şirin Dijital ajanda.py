...
class CalendarApp:
    def __init__(self, root):
        ...
        self.view_events_button = tk.Button(self.frame2, text="Etkinlikleri Göster", command=self.view_events)
        self.view_events_button.grid(row=2, column=3, padx=5, pady=10)
        
        self.btn_update_event = tk.Button(self.frame2, text="Etkinlik Güncelle", command=self.update_event)
        self.btn_update_event.grid(row=2, column=4, padx=5)

        self.btn_delete_event = tk.Button(self.frame2, text="Etkinlik Sil", command=self.delete_event)
        self.btn_delete_event.grid(row=2, column=5, padx=6)
        
        self.btn_set_reminder = Button(self.frame2, text="Hatırlatıcı Ekle", command=self.set_reminder)
        self.btn_set_reminder.grid(row=2, column=6, padx=7)
